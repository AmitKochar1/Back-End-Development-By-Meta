...
def calculate_subtotal(orderList):
...
def calculate_tax(subtotal):
    ...
    ### WRITE SOLUTION HERE
    fee = 15
    tax = (float(subtotal) * float(fee)) / 100
    return round(tax, 2)
...
def main():
    ...
    print('You have ordered the following items: ' + str(items))
    print ('Total order cost is:$ ' + str(subtotal))
